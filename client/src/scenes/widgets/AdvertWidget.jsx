          ...
          <Box sx={{ display: "flex", gap: "1rem", alignItems: "flex-end" }}>
            <Box flex={1}>
              <Typography color="textSecondary" mb={2}>
                This is the highlights page. Check them out by scrolling down.
              </Typography>
              <Box
                sx={{
                  display: "flex",
              ...
              >
                ...
                >
                  Scroll down <ArrowDownward sx={{ marginLeft: "0.5rem" }} />
                </Button>
              </Box>
            </Box>
            <Box flex={1}>
              ...
              >
                Open gallery <TouchAppOutlined sx={{ marginLeft: "0.5rem" }} />
              </Button>
            </Box>
          </Box>
