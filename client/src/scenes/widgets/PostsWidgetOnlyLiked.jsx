...
import PostWidget_Liked from "./PostWidget_Liked";
import { Container, Row, Col } from "react-grid-system";
import { Pagination } from "@mui/material";
import { getLikedPosts, getUserPosts, getPostsAll } from "components/api";

const PostsWidgetOnlyLiked = ({
  sortCriteria,
  filterCriteria,
  colorCriteria,
  xl,
  ...
  useEffect(() => {
    getLikedPosts(dispatch, loggedInUserId._id);
...
export default PostsWidgetOnlyLiked;
